using UnityEngine;
using MathUtils = TriplanoTest.Shared.Utils.MathUtils;
...
namespace TriplanoTest.Shared.ExtensionMethods {
    ...
    public static class GizmosExtensions {
        ...
        {
            DrawDistanceLine(transform, distance, Color.cyan);
        }
        ...
        {
            DrawLineBetween(transform, avarageDistance, Color.cyan);
        }
        ...
        {
            DrawAverageLine(transform, avarageDistance, Color.cyan, Color.green);
        }
